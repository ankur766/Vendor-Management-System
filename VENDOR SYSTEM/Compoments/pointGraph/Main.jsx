...
class Main extends Component {
  constructor(props) {
   ...
   // Add a lifecycle method to start the interval when the component mounts
   componentDidMount() {
    // Call updateCharts every 1 second
    this.interval = setInterval(this.updateCharts, 1000);
  }

  // Add a lifecycle method to clear the interval when the component unmounts
